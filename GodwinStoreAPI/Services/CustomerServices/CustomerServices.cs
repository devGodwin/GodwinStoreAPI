...
public class CustomerServices : ICustomerServices
{
    ...
    public async Task<BaseResponse<PaginatedResponse<RegisterCustomerResponseModel>>> GetCustomersAsync(CustomerFilter customerFilter)
    {
        try
        { 
            ...
            { 
                customerQueryable = customerQueryable.Where(x => x.Email.ToLower().Equals(customerFilter.Email.ToLower())); 
            }
